                ...
                <div className="w-full flex flex-col items-center gap-14">
                    ...
                    <form className="w-full flex flex-col justify-center items-center gap-14" onSubmit={handleSubmit}>
                        <div className="w-5/6 h-12 bg-white rounded-xl flex items-center">
                            ...
                            <input className="w-full h-full rounded-xl p-5 text-xl font-light outline-none" name="buyerName" type="text" placeholder="Ingrese su nombre y apellido" onBlur={handleBlur} onChange={handleChange} value={form.name} required />
                        </div>
                        <div className="w-5/6 h-12 bg-white rounded-xl flex items-center">
                            <label htmlFor="buyerPhone" className="p-3">
                                <FontAwesomeIcon className="text-2xl text-yellow" icon={faPhone} />
                            </label>
                            <input className="w-full h-full rounded-xl p-5 text-xl font-light outline-none" name="buyerPhone" type="number" placeholder="Ingrese su teléfono" onBlur={handleBlur} onChange={handleChange} value={form.phone} required />
                        </div>
                        <div className="w-5/6 h-12 bg-white rounded-xl flex items-center">
                            <label htmlFor="buyerEmail" className="p-3">
                                <FontAwesomeIcon className="text-2xl text-yellow" icon={faAt} />
                            </label>
                            <input className="w-full h-full rounded-xl p-5 text-xl font-light outline-none" name="buyerEmail" type="email" placeholder="Ingrese su correo electrónico" onBlur={handleBlur} onChange={handleChange} value={form.email} required />
                        </div>
