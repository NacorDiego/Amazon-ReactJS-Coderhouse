...
function ButtonAddToCart() {
    return (
        <button className="w-14 h-7 flex justify-center items-center border-2 border-sky-100 hover:bg-sky-100 hover:text-blue-700 rounded-full text-lg text-sky-100">
